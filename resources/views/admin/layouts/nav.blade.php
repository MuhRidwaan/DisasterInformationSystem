        ...
        <div class="page-container topbar-menu">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="topbar-item">
                    <div class="dropdown">
                        <button class="topbar-link" data-bs-toggle="dropdown" data-bs-offset="0,25" type="button"
                            ...
                            <img src="{{ asset('images/flags/us.svg') }}" alt="user-image" class="w-100 rounded"
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="en">
                                <img src="{{ asset('images/flags/us.svg') }}" alt="user-image" class="me-1 rounded"
                ...
                <div class="topbar-item d-none d-sm-flex">
                    <div class="dropdown">
                        <button class="topbar-link dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown"
                            data-bs-offset="0,18" type="button" aria-haspopup="false" aria-expanded="false">
                ...
                <div class="topbar-item nav-user">
                    <div class="dropdown">
                        <a class="topbar-link dropdown-toggle drop-arrow-none px-2" href="#"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ asset('images/users/avatar-1.jpg') }}" width="32"
                                class="rounded-circle me-lg-2" alt="user-image">
                            <span class="d-lg-inline d-none">
                                <h6 class="my-0">{{ Auth::user()->name ?? 'Guest' }}</h6>
                            </span>
                            <i class="ri-arrow-down-s-line d-none d-lg-inline align-middle ms-1"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
