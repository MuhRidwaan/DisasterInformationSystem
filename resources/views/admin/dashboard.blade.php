    ...
    <div class="page-container">
        ...
        <div class="row row-cols-xxl-4 row-cols-md-2 row-cols-1">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex align-items-center gap-2 justify-content-between">
                            <span class="badge bg-primary rounded-pill fs-13">45% <i class="ti ti-trending-up"></i>
                            </span>
                            <div class="text-end">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex align-items-center gap-2 justify-content-between">
                            <span class="badge bg-success rounded-pill fs-13">28% <i class="ti ti-trending-up"></i>
                            </span>
                            <div class="text-end">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex align-items-center gap-2 justify-content-between">
                            <span class="badge bg-warning rounded-pill fs-13">18% <i class="ti ti-trending-up"></i>
                            </span>
                            <div class="text-end">
                        ...
                        <div class="progress progress-soft progress-sm mt-3">
                            <div class="progress-bar bg-warning" role="progressbar" style="width: 18%" aria-valuenow="18"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex align-items-center gap-2 justify-content-between">
                            <span class="badge bg-info rounded-pill fs-13">3.2% <i class="ti ti-trending-down"></i>
                            </span>
                            <div class="text-end">
                        ...
                        <div class="progress progress-soft progress-sm mt-3">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 7.5%" aria-valuenow="7.5"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-xl-6">
                <div class="card">
                    <div
                        class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2 border-bottom border-dashed">
                        <h4 class="header-title">Orders Statistics</h4>

                        <div class="d-flex gap-2 justify-content-end text-end">
                            <a href="javascript:void(0);" class="btn btn-sm btn-light">Refresh <i
                                    class="ri-refresh-line ms-1"></i></a>
                        </div>
                    </div>
                    <div class="card-body pt-2">
                        <div dir="ltr">
                            <div id="data-visits-chart" class="apex-charts"
                                data-colors="#1478f0,#faae37,#30cf46,#4bbee1"></div>
                                ...
                                <div class="col">
                                    <div class="d-flex justify-content-between align-items-center p-1">
                                        ...
                                        <span class="fw-semibold text-muted float-end"><i
                                                class="ri-arrow-down-s-fill text-danger"></i> 965</span>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center p-1">
                                        ...
                                        <span class="fw-semibold text-muted float-end"><i
                                                class="ri-arrow-up-s-fill text-success"></i> 75</span>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex justify-content-between align-items-center p-1">
                                        ...
                                        <span class="fw-semibold text-muted float-end"><i
                                                class="ri-arrow-up-s-fill text-success"></i> 102</span>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center p-1">
                                        ...
                                        <span class="fw-semibold text-muted float-end"><i
                                                class="ri-arrow-down-s-fill text-danger"></i> 96</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row row-cols-xxl-5 row-cols-md-2 row-cols-1">
            <div class="col">
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        <img src="assets/images/users/avatar-7.jpg" alt="team-member-image"
                            class="me-1 avatar-xl img-thumbnail rounded-circle">
                        <div>
                            <h5>John Smith</h5>
                            <p class="text-muted">Project Manager</p>
                            <p class="m-0 fs-14">80+ Feedbacks <a href="#!" class="link-reset fw-medium"><i
                                        class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        <img src="assets/images/users/avatar-4.jpg" alt="team-member-image"
                            class="me-1 avatar-xl img-thumbnail rounded-circle">
                        <div>
                            <h5>Jane Doe</h5>
                            <p class="text-muted">UI/UX Designer</p>
                            <p class="m-0 fs-14">90+ Feedbacks <a href="#!" class="link-reset fw-medium"><i
                                        class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        <img src="assets/images/users/avatar-5.jpg" alt="team-member-image"
                            class="me-1 avatar-xl img-thumbnail rounded-circle">
                        <div>
                            <h5>Emily Brown</h5>
                            <p class="text-muted">Software Engineer</p>
                            <p class="m-0 fs-14">100+ Feedbacks <a href="#!" class="link-reset fw-medium"><i
                                        class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        <img src="assets/images/users/avatar-6.jpg" alt="team-member-image"
                            class="me-1 avatar-xl img-thumbnail rounded-circle">
                        <div>
                            <h5>Mark Wilson</h5>
                            <p class="text-muted">Marketing Specialist</p>
                            <p class="m-0 fs-14">70+ Feedbacks <a href="#!" class="link-reset fw-medium"><i
                                        class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        <img src="assets/images/users/avatar-3.jpg" alt="team-member-image"
                            class="me-1 avatar-xl img-thumbnail rounded-circle">
                        <div>
                            <h5>Sara Johnson</h5>
                            <p class="text-muted">Data Analyst</p>
                            <p class="m-0 fs-14">50+ Feedbacks <a href="#!" class="link-reset fw-medium"><i
                                        class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="d-flex card-header justify-content-between align-items-center">
                        ...
                        <a href="javascript:void(0);" class="btn btn-sm btn-primary">Add Brand <i
                        ...
                        <div class="align-items-center justify-content-between row text-center text-sm-start">
                            <div class="col-sm">
                                <div class="text-muted">
                                    Showing <span class="fw-semibold">5</span> of <span class="fw-semibold">20</span>
                                    Results
                                </div>
                            </div>
                            ...
                            <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                                <tbody>
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="assets/images/products/p-1.png" alt="Product-10"
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="assets/images/products/p-2.png" alt="Product-11"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="assets/images/products/p-3.png" alt="Product-12"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="assets/images/products/p-4.png" alt="Product-13"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="assets/images/products/p-5.png" alt="Product-14"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
